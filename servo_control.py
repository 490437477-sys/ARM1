...
class ServoControlApp:
    ...
    def create_connect_ui(self):
        ...
        for i, servo in enumerate(SERVOS):
            ...
            angle_label = ttk.Label(servo_frame, text=f"{servo['init']} deg", width=7, font=('Arial', 12))
        ...
        ttk.Button(button_frame, text="Reset", command=self.zero_all, width=10).pack(side=tk.LEFT, padx=8)
        ttk.Button(button_frame, text="Exit", command=self.on_closing, width=10).pack(side=tk.LEFT, padx=8)
